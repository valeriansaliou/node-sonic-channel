...
SonicChannelSearch.prototype.query = function(
  ...
  if (terms.length >= this._options.textMaximumLength) {
    throw new Error(
      "The terms value is too long (maximum length set to: " +
...
SonicChannelSearch.prototype.suggest = function(
  ...
  return this._executeOrDefer("suggest", [
    collection, bucket, word, done
  ]);
};
