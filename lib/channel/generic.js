...
var SonicChannelGeneric = function(mode, options) {
  ...
  if (typeof options.textMaximumLength !== "undefined"  &&
        (typeof options.textMaximumLength !== "number" ||
          options.textMaximumLength < 0)) {
    throw new Error("Invalid options.textMaximumLength");
  }

  // Environment
  var offlineStackMaxSizeDefault = 10000;
  var textMaximumLengthDefault   = 4000;
  ...
  this._options          = {
    ...
    textMaximumLength : (
      typeof options.textMaximumLength === "number" ?
        options.textMaximumLength : textMaximumLengthDefault
    )
  };
...
SonicChannelGeneric.prototype.__handleDataLine_connected = function(
  ...
  if (this._options.auth !== null) {
    startValues.push(this._options.auth);
  }
